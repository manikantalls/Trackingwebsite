            ...
            <table className="w-full text-xs whitespace-nowrap">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  {['CW Consolidation', 'LLS Reference', 'Supplier', 'Invoice Spl', 'Delivery Note', 'PO', 'Part Number', 'Quantity', 'Package', 'Weight (kg)', 'Pick Up', 'ETS', 'ETA', 'ETA Knipping', 'DDP ETA KN-MX', 'Status'].map((h, i) => (
