            ...
            <table className="w-full text-xs whitespace-nowrap">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  {['CW Consolidation', 'LLS Reference', 'Supplier', 'Invoice Spl', 'Delivery Note', 'PO', 'Part Number', 'Quantity', 'Package', 'Weight (kg)', 'Pick Up', 'ETS', 'ETA', 'Transit Time (Days)', 'DDP ETA KN-MX', 'Requested DDP ETA KN-MX', 'DDP ETA Deviation (Days)', 'Status', 'Remarks', 'Invoice LLS'].map((h, i) => (
